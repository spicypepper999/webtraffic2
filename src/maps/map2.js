...
const mark1 = new SpecialLaneNode(road2.lastNode().getSourceNodesNormalized()[0], []);
road2.updateLaneNodeReference(road2.lastNode().getSourceNodesNormalized()[0], new SpecialLaneNode(road2.lastNode().getSourceNodesNormalized()[0], []));
