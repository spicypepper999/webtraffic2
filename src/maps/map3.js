...
road3.updateLaneNodeReference(road3.firstNode().getExitNodesNormalized()[0], exit1);

const exit2 = new SpecialLaneNode(road4.firstNode().getExitNodesNormalized()[0], ["exit", road4.firstNode().getExitNodesNormalized()[0].lanes[0], 100, 2]);
road4.updateLaneNodeReference(road4.firstNode().getExitNodesNormalized()[0], exit2);
