...
console.log(map1.roads[0]);
console.log(map1.roads[3]);
...
map1.vehicles.push(new Vehicle(0, map1.roads[2].lanes[0], 0, 100));
map1.vehicles.push(new Vehicle(50, map1.roads[6].lanes[1], 0, 100));
map1.vehicles.push(new Vehicle(50, map1.roads[5].lanes[1], 0, 100));
